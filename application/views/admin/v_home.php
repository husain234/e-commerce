                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/template/dist
                     ') ?>/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/template/dist
                     ') ?>/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="<?php echo base_url('assets/template/dist
                   ') ?>/img/user1-128x128.jpg" alt="message user image">
                      <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="<?php echo base_url('assets/template/dist
                   ') ?>/img/user3-128x128.jpg" alt="message user image">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/template/dist
                       ') ?>/img/user1-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/template/dist
                       ') ?>/img/user7-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/template/dist
                       ') ?>/img/user3-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/template/dist
                       ') ?>/img/user5-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/template/dist
                       ') ?>/img/user6-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/template/dist
                       ') ?>/img/user8-128x128.jpg" alt="User Image">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                   ...
                   ') ?>/img/user6-128x128.jpg" alt="User Image">
                    ...
                    <li>
                      <img src="<?php echo base_url('assets/template/dist
                   ') ?>/img/user2-160x160.jpg" alt="User Image">
                   ...
                   ') ?>/img/user5-128x128.jpg" alt="User Image">
                    ...
                    <li>
                      <img src="<?php echo base_url('assets/template/dist
                   ') ?>/img/user4-128x128.jpg" alt="User Image">
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="<?php echo base_url('assets/template/dist
                 ') ?>/img/default-50x50.gif" alt="Product Image">
                  </div>
